...
const UpdateTravelerDetails = (props) => {
  ...
  const onSubmit = (values) => {
    console.log("submit regard",values)
      axios
      .put(`http://localhost:8080/traveler/updateTravelerDetails/${props.match.params._id}`, values)
      .then((res) => {
                    ...
                    <Col md="12">
                      <FormGroup>
                        ...
                        <Input
                          ...
                          defaultValue={addsData.Traveler_Name}
                          id="Traveler_Name "
                          name="Traveler_Name"
                    ...
                    <Col md="6">
                      <FormGroup>
                        ...
                        <Input
                          onChange={formik.handleChange}
                          onBlur={formik.handleBlur}
                          defaultValue={addsData.Traveler_ID}
                          id="Traveler_ID"
                          name="Traveler_ID"
                          type="text"
                        />
                    ...
                    <Col md="6">
                      <FormGroup>
                        ...
                        <Input
                          onChange={formik.handleChange}
                          onBlur={formik.handleBlur}
                          defaultValue={addsData.Contact_Number}
                          id="Contact_Number"
                          name="Contact_Number"
                      ...
                      <FormGroup>
                        ...
                        <InputGroup className="input-group-alternative">
                          ...
                          <ReactDatetime
                            ...
                            onBlur={formik.handleBlur}
                            defaultValue={addsData.checkInDate}
                          />
                        </InputGroup>
                      </FormGroup>
                    </Col>
                    <Col md="6">
                      <FormGroup>
                        ...
                        <Input
                          onChange={formik.handleChange}
                          onBlur={formik.handleBlur}
                          defaultValue={addsData.numberOfNights}
                          id="numberOfNights"
                          name="numberOfNights"
                          type="select"
                        >
                          <option>{addsData.numberOfNights}</option>
                    ...
                    <Col md="6">
                      <FormGroup>
                        ...
                        <Input
                          onChange={formik.handleChange}
                          onBlur={formik.handleBlur}
                          defaultValue={addsData.Room_Type}
                          id="Room_Type"
                          name="Room_Type"
                          type="select"
                        >
                          <option>{addsData.Room_Type}.</option>
                    ...
                    <Col md="6">
                      <FormGroup>
                        ...
                        <Input
                          onChange={formik.handleChange}
                          onBlur={formik.handleBlur}
                          defaultValue={addsData.numberOfRooms}
                          id="numberOfRooms"
                          name="numberOfRooms"
                          type="select"
                        >
                          <option>{addsData.numberOfRooms}</option>
...
export default UpdateTravelerDetails;
