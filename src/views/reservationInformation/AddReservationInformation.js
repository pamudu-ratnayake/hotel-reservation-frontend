...
const AddReservationInformation = () => {
  ...
  const onSubmit = (values) => {
    ...
    axios.post(`http://localhost:8080/hotelreservation/add-hotelReservation`, values)
    .then((res) => {
                    ...
                    <Col md="6">
                      <FormGroup>
                        ...
                        <Input
                          ...
                          onChange={formik.handleChange}
                          onBlur={formik.handleBlur}
                          value={formik.values.con_number}
                        />
...
export default AddReservationInformation;
